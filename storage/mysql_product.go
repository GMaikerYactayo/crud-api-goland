...
func (p *mySQLProduct) Create(m *model.Product) error {
...
func (p *mySQLProduct) GetAll() (model.Products, error) {
...
func (p *mySQLProduct) GetByID(id int) (*model.Product, error) {
...
func (p *mySQLProduct) Update(id int, m *model.Product) error {
...
func (p *mySQLProduct) Delete(id int) error {
